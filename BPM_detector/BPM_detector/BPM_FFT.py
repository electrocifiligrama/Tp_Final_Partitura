...
MINIMUM_F= 1
MAXIMUM_F = 3
def BPM_estimate(buffer,f_s=44100,n_samples=1024,alpha=0.85):
    buffer_size = len(buffer)
    number_of_frames = math.ceil( buffer_size/n_samples )
    n_fft = int(10*number_of_frames)
    ...
    bin_start = int(MINIMUM_F/freq_res)
    bin_stop = int(MAXIMUM_F/freq_res)
