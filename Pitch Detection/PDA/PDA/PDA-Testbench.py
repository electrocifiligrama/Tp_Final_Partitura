...
files = ["saxophone_B3.wav","guitar_G3.wav","trumpet_A4.wav","violin_A4.wav",
         ...
         "tuba_A1.wav","pianoChord_C4.wav"]
freq = [247,195,440,440,117,784,659,1319,698,55,262]
for j in range(0,len(files)):
    ...
    #print("YIN: %s Hz - %s MIDI" % (round(YINfreq),PDA.freqToPitch(YINfreq))) # falla en bass_clarinet
    print(" ")
